package com.pedroalmir.testPriorization.util.generator;
...
public class DataGenerator {
	 ...
	 * 
	 */
	private final static String BASE_FOLDER = "C:/Users/Pedro Almir/Dropbox/UFPI/Mestrado/Priorização de Casos de Teste/Arquivos Base/AleatoriosNovaAbordagem/cl_50000_req_100/";
    
    public static void main(String[] args) throws IOException {
            
            //1000-20
            generetaFiles(50000, 100);
    ...
    public static void generetaFiles(int contClass, int reqCount) throws IOException{
            ...
            generateCyclomaticComplexity(contClass, BASE_FOLDER + "CyclomaticComplexity-cl-"+contClass+".csv");
    }
    ...
    private static void generateCyclomaticComplexity(int numberOfClass, String addressFile) throws IOException {
        Random random = new Random();
